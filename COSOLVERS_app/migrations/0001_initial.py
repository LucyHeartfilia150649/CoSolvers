    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "suggestion_text",
                    models.TextField(verbose_name="ข้อเสนอแนะแนวทางแก้ไข"),
                ),
                (
                    "votes",
                    models.IntegerField(default=0, verbose_name="คะแนนโหวตสนับสนุน"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="วันที่เสนอแนะ"
                    ),
                ),
                (
                    "problem",
